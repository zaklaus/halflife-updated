...
#include "CSpectatorHandler_Command.h"
#include "pm_shared.h"
#include "hud/CHud.h"
...
void SpectatorPanel::Initialize()
{
    ...
    m_OptionButton = new DropDownButton(CHudTextMessage::BufferedLocaliseTextString("#SPECT_OPTIONS"), XRES(15), YRES(6), XRES(OPTIONS_BUTTON_X), YRES(20),
                                        false, false);
    ...
    m_CamButton = new DropDownButton(CHudTextMessage::BufferedLocaliseTextString("#CAM_OPTIONS"), ScreenWidth - (XRES(CAMOPTIONS_BUTTON_X) + 15), YRES(6),
                                     XRES(CAMOPTIONS_BUTTON_X), YRES(20), false, false);
    ...
    m_NextPlayerButton = new CImageButton("arrowright", (ScreenWidth - (XRES(CAMOPTIONS_BUTTON_X) + 15)) - XRES(24 + 15), YRES(6), XRES(24), YRES(20), false,
                                          false);
...
void SpectatorPanel::Update()
{
    ...
    for (j = 0; j < TEAM_NUMBER; j++)
    {
        ...
        m_TeamScores[j]->setBounds(ScreenWidth - (iTextWidth + XRES(2 * SEPERATOR_WIDTH + 2 * SEPERATOR_WIDTH / 2 + offset) + iwidth),
